...
public class Candidat implements Comparable <Candidat>{
    ...
    public Candidat(String nume, String prenume, String CNP, double medie_Bac, double medie_proba_obligatorie, double medie_proba_optionala, String profil_liceu, double medie_examen) {
        this.nume = nume;
        this.prenume = prenume;
        this.CNP = CNP;
        this.medie_Bac = medie_Bac;
    ...
    public Candidat(int id_candidat, String nume, String prenume, String CNP, double medie_Bac, double medie_proba_obligatorie, double medie_proba_optionala, String profil_liceu, double medie_examen) {
