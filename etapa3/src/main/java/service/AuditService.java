...
public class AuditService {
    ...
    private AuditService() {
        cale_fisier = "src/main/java/date/AuditService.csv";
        header_fisier = "nume_actiune, timestamp_actiune, nume_thread\n";
...
//    }
    ...
    public void scrieDate(String nume_actiune, Date data, String thread_name) {
