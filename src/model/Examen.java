...
public class Examen {
    ...
    public Examen(String nume) {
        this.nume = nume;
        if (nume.equals("Examen la domeniul de licenta Informatica"))
        ...
        else if (nume.equals("Examen la domeniul de licenta Matematica"))
        ...
        else if (nume.equals("Examen la domeniul de licenta Calculatoare si tehnologia informatiei"))
